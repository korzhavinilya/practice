...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_b = typeof common_2.CreateOrderRequest !== "undefined" && common_2.CreateOrderRequest) === "function" ? _b : Object, Object]),
    __metadata("design:returntype", Promise)
...
let OrdersService = class OrdersService {
    ...
    async createOrder(request, authentication) {
        ...
        try {
            ...
            await (0, rxjs_1.lastValueFrom)(this.billingClient.emit(common_2.RmqPatterns.ORDER_CREATED, {
                request,
